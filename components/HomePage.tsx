...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen relative" style={{
      ...
      {/* Hero Section */}
      <section className="py-20 px-4 bg-transparent relative overflow-hidden z-10">
        ...
        <div className="container mx-auto text-center relative z-10">
          <ScrollReveal>
            ...
            <h1 className="text-5xl md:text-6xl font-outfit font-bold mb-6 leading-tight text-primary">
              Save Lives with
              <span className="block text-secondary mt-2">Real-Time Blood Alerts</span>
            </h1>
            <p className="text-xl mb-8 max-w-3xl mx-auto leading-relaxed text-text-dark font-dm-sans">
          ...
          {/* Stats */}
          <ScrollReveal delay={0.2} className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto relative z-20">
