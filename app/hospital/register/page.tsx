...
export default function HospitalRegistration() {
  ...
  if (isSubmitted) {
    return (
      <GradientBackground className="product-form-page hospital-registration flex items-center justify-center p-4">
  ...
  return (
    <GradientBackground className="product-form-page hospital-registration p-4">
